...
export default function WaitlistPage() {
  ...
  return (
    <div className="waitlist-page">
      ...
      <section className="waitlist-section waitlist-bottom-cta">
        <div className="waitlist-section-inner waitlist-bottom-inner">
          <h2 className="waitlist-section-title">Tu opinión importa</h2>
          <p className="waitlist-bottom-sub">
            Ayúdanos a validar si Q-Pay resuelve un problema real para ti.
          </p>
          <ValidationForm
            idPrefix="bottom"
            email={email}
